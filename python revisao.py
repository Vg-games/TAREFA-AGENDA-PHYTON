...
#  solicitar o nome do contato ao usuário, com opção de colocar o valor
...
# solicita o telefone do contato ao usuário, com opção de valor
...
#  solicitar o endereço do contato ao usuário
...
# para solicitar a cidade do contato ao usuário,
...
# Função para solicitar a UF do contato
def pede_uf(padrao=""):
    uf = input("UF: ")
    if uf == "":
        uf = padrao
